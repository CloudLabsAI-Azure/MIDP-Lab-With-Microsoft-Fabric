...
17. In the **Data Management** page, select the **Data (1)** in the left navigation pane and select **Ingest data (2)** action.

    ![DataManagement](../media/03/E1-T1.1-S17.png)
...
22. In the **Subscription** dropdown list, select the subscription given by default.
...
42. In the **Results** pane (located along the bottom), review the query result expressed as a chart. Please note that it may take up to 2-3 minutes to accumulate data. If you do not see any result please re-run the query after some time. 
...
43. Notice that the temperature in the Miami store is oscillating between 65 and 70 degrees Fahrenheit. Based on these insights, we are able to adjust the temperatures to optimal levels.
